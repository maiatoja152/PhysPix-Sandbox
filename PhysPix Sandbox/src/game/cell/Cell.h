...
namespace cell_id
{
	...
	static constexpr uint8_t hydrogen = 13;
	static constexpr uint8_t dirt = 14;
...
namespace cell_density
{
	...
	static constexpr uint8_t hydrogen = 98;
...
namespace cell_color
{
	...
	static constexpr glm::vec4 hydrogen = { 0.78f, 0.46f, 0.19f, 1.0f };
	static constexpr glm::vec4 dirt = { 0.27f, 0.13f, 0.027f, 1.0f };
